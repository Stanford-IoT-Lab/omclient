...
function LDGetPublicChatMembersResponse(e) {
    ...
    if(e && (e['m'] !== null && e['m'] !== undefined)) {
        ...
        var d = e['m'];
        for(var k in d) this.IdToDisplayName[k] = d[k];
    }
}
...
LDGetPublicChatMembersResponse.prototype.encode = function (o) {
    if(o === undefined) o = {};
    LDJSONLoggable.prototype.encode.call(this, o);
    if(this.IdToDisplayName !== null) {
        o['m'] = {};
        var d = this.IdToDisplayName;
        for(var k in d) o['m'][k] = d[k];
    } else {
        o['IdToDisplayName'] = null;
    }
    return o;
}
LDGetPublicChatMembersResponse.prototype.IdToDisplayName = null;
